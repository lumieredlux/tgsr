...
buttons = InlineKeyboardMarkup(
         [[
               InlineKeyboardButton("ᴅᴇᴠ", url="https://t.me/Vastavikrahul"),
	       InlineKeyboardButton("ᴛᴜᴛᴏʀɪᴀʟ", url="https://youtube.com/@vastavikrahul?feature=shared"), 
         ],[
               InlineKeyboardButton("ᴀᴅᴍɪɴs ᴘᴀɴɴᴇʟ", callback_data="admin_"),    
         ],[
	       InlineKeyboardButton("ɪɴsᴛʀᴜᴄᴛɪᴏɴ", callback_data="help2_"), 
...
async def start(_,message):
  ...
  if join ==1:
    return
  await message.reply_photo(photo="https://telegra.ph/file/313c627b8be74ea89c68a.jpg",
